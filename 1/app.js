...
let STAR_COUNT = 0
  ...
  , starPhase = null
  , starGeo = null;
const RingText = [...window.dataFromSubdomain && window.dataFromSubdomain.data.candyTexts ? window.dataFromSubdomain.data.candyTexts : ["hi ❤️", "谢谢你朋友 ✨", "사랑해요 💖", "힘내요! 🌟", "あなたが好き 🥰", "元気ですか？ 🌈"]];
let bgMusic = null
  , musicStarted = !1;
