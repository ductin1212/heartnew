...
let STAR_COUNT = 0
  ...
  , starPhase = null
  , starGeo = null;
const RingText = [...window.dataFromSubdomain && window.dataFromSubdomain.data.candyTexts ? window.dataFromSubdomain.data.candyTexts : ["Xin Lỗi Mà ❤️", "Xin Lỗi Nha ✨", "Xin Lỗi 💖", "Tha Lỗi Cho T Nha 🌟", "Yêu Yêu Yêu 🥰", "Xin Lỗi 🌈"]];
let bgMusic = null
  , musicStarted = !1;
