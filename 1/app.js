...
let STAR_COUNT = 0
  ...
  , starPhase = null
  , starGeo = null;
const RingText = [...window.dataFromSubdomain && window.dataFromSubdomain.data.candyTexts ? window.dataFromSubdomain.data.candyTexts : ["Ngoài Cùng ❤️", "Bên Trong✨", "Giũa💖", "Bên Nào 🌟", "Đẹp Nhất🥰", "Cầu Vồng🌈"]];
let bgMusic = null
  , musicStarted = !1;
